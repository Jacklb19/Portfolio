...
import { Home, User, Briefcase, FolderOpen, Mail, Github, Linkedin, Settings, AlertTriangle } from "lucide-react"
...
export function BottomNav({ activeSection, onSectionChange }: BottomNavProps) {
  ...
  const navItems = [
    ...
    { icon: Briefcase, label: t("experience"), id: "experience", type: "section" as const },
    { icon: FolderOpen, label: t("projects"), id: "projects", type: "section" as const },
    { icon: Mail, label: t("contact"), id: "contact", type: "section" as const },
    { icon: Github, label: "GitHub", id: "github", type: "link" as const, href: "https://github.com/Jacklb19" },
    { icon: Linkedin, label: "LinkedIn", id: "linkedin", type: "link" as const, href: "https://www.linkedin.com/in/jose-luis-burbano-buchelly-a1313834a/" },
    { icon: Settings, label: t("settings"), id: "settings", type: "action" as const },
    { icon: AlertTriangle, label: "Don't Click", id: "dont-click", type: "action" as const },
  ]
  ...
  return (
    <>
      <nav className="fixed bottom-0 left-0 right-0 z-50 md:hidden">
        <div className="backdrop-blur-md bg-black/50 dark:bg-black/70 border-t border-white/10">
                  ...
                  >
                    <item.icon
                      className={cn(
                        ...
                        item.type === "section" && activeSection === item.id && "scale-110",
