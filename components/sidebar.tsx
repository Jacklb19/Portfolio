...
export function Sidebar({ activeSection, onSectionChange, isExpanded, onToggleExpand }: SidebarProps) {
  ...
  return (
    <>
              ...
              <div className="flex items-center gap-3">
                <div className="h-12 w-12 flex-shrink-0 rounded-full bg-gradient-to-br from-primary to-accent overflow-hidden">
                  <div className="h-12 w-12 flex-shrink-0 rounded-full bg-gradient-to-br from-primary to-accent overflow-hidden relative">
                    <Image src="/images/profile.jpg" alt="Jose Burbano" fill className="object-cover" sizes="48px" />
                  </div>
                </div>
                {isExpanded && (
      ...
      <SearchModal isOpen={showSearch} onClose={() => setShowSearch(false)} onNavigate={onSectionChange} />
    </>
  )
}
